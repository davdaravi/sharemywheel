...
smw.responsUploadImage=function(resp){
	...
	else if(resp['status']==true)
	{
		...
		{
			$("#userimage").attr("src","/images/default.png");	
			$("#loginuserpic").attr("src","/images/default.png");
		}
		else
		{
			$("#userimage").attr('src',"/images/profile/"+resp['userid']+"/"+resp['path']);
			$("#loginuserpic").attr("src","/images/profile/"+resp['userid']+"/"+resp['path']);
		}
