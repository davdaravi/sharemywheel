                ...
                if(isset($request['username']) && isset($request['password']))
                {
                    ...
                    else
                    {
                        ...
                        if(count($userdd)>0)
                        {
                            ...
                            {
                                return redirect('/')->withErrors(["error"=>"User is not allow to login in our system.."])->withInput();
                            }
                            else
                            {
                                ...
                                else
                                {
                                    ...
                                    return redirect('/')->withErrors(["error"=>"Username or Password is incorrect.."])->withInput();
                                }
                            }
