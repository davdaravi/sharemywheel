    ...
    <div class="col-md-12">
        <div class="col-md-3 sharingRideFilter">
            <div class="col-md-12">
                ...
                <input type="text" id="fromdate" name="fromdate" value="@if(isset($_COOKIE['ridedate'])){{$_COOKIE['ridedate']}}@elseif(isset($ride['date'])){{$ride['date']}}@else{{""}}@endif" placeholder="sharingRideSearch Date" class="form-control"/>
            </div>
...
function searchTable()
{
    ...
    {
        $.toaster({ priority : 'danger', title : 'Title', message : 'Enter Correct From City'});
    }
    else if(currentTo!=oldTo)
    {
        $.toaster({ priority : 'danger', title : 'Title', message : 'Enter Correct To City'});   
    }
    else
    {
        rideTable.fnDraw();
