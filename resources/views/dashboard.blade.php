...
<div class="tab-content">
    ...
    <div class="tab-pane fade" id="booking">
        <div class="tabbable tabs-left">
            <ul class="nav nav-tabs">
                <li class="active bookingHistory"><a href="#bookingHistory" data-toggle="tab">Booking history</a>
                </li>
                <li class="ridebooked"><a href="#ridebooked" data-toggle="tab">Ride Booked</a>
                </li>
            </ul>
            <div class="tab-content col-md-8 col-sm-8 col-xs-12">
